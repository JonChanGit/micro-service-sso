...
public class Swagger2Config {
    ...
    @Value("${app.client-id:app}")
    private String clientId;
    @Value("${app.client-secret:123456}")
    private String clientSecret;
    @Value("${app.auth-server:http://localhost:8080}")
    ...
    public Docket petApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.zsf.sas.controller"))
